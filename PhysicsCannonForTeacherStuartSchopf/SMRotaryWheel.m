...
- (void) drawWheel {
    ...
    for (int i = 0; i < numberOfSections; i++) {
        ...
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
            ...
            [im setFrame:CGRectMake(0,0, 50, 50)];
        ...
        UILabel *numberLabel = [[UILabel alloc] initWithFrame:CGRectMake(12, 15, 20, 20)];
        numberLabel.backgroundColor = [UIColor clearColor];
        numberLabel.text = [NSString stringWithFormat:@"%d",i * 10 + 20];
        [im addSubview:numberLabel];
...
//    [self addSubview:bg];
//    
//    UIImageView *mask = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 33, 33)];
...
- (NSString *) getCloveName:(int)position {
    ...
    res = [NSString stringWithFormat:@"%d",10 * position + 20];
    return res;
}
